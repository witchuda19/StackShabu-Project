...
<header class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-center space-x-4">
        <img src="{{ asset('image/logo.png') }}" class="w-16 h-auto">
    </div>
</header>
<div>
    <h1 class="font-bold text-2xl text-center">Home Menu List</h1>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td>
                    <img src="{{ asset($rs->image) }}" alt="Uploaded Image" class="w-20 h-auto">
                </td>
                <td>
                    {{ $rs->description }}
                </td>
