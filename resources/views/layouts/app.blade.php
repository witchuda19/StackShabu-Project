...
<body>
    <header class="px-4 py-2 bg-red-800">
            ...
            <div class="flex items-center">
                ...
                <button data-notifications class="p-3 mr-3 focus:outline-none hover:bg-gray-200 hover:rounded-md" typle="button">
                    <svg class="fill-current w-5" viewBox="-21 0 512 512">
                        ...
                        <path style="fill: rgb(47, 0, 255);" d="M469.344 106.668c0 58.91-47.754 106.664-106.668 106.664-58.91 0-106.664-47.754-106.664-106.664C256.012 47.758 303.766 0 362.676 0c58.914 0 106.668 47.758 106.668 106.668zm0 0" />
                    </svg>
                </button>
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-red-800 border-r rtl:border-r-0 rtl:border-l dark:bg-red-700 dark:border-gray-700">
            <div class="sidebar text-center bg-red-800">
                ...
                <a href="{{ route('shabus.create') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Customer</span>
                    </div>
                </a>
